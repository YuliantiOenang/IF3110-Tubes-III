	...
	<div class='head'>
		...
		<div class='status'>
			...
			<p class="left">
				...
				(<a
					href="http://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/logout">Logout</a>)
			</p>
			<p class="right">
			...
			<p class="left">
				welcome, <a
					href="http://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/user?id=<%=request.getSession(true).getAttribute("user_id")%>"><%=request.getSession(true).getAttribute("username")%></a>!
				(<a
					href="http://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/admin?action=main">Admin</a>
				| <a
					href="http://<%=request.getServerName()%>:<%=request.getServerPort()%><%=request.getContextPath()%>/logout">Logout</a>)
			</p>
			<p class="right">
