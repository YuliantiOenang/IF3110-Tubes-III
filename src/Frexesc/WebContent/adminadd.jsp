...
<body>
	...
	<form action="admin" method="post" enctype="multipart/form-data">
		<div class="register_div">
			...
			<div class="per_form">
				<label>Name: </label><input type="text" id="name" name="name" /> <span
					class="error" id="fullname"></span>
			</div>
			<div class="per_form">
				<label>Category: </label> <select name="category">
					...
					%>
				</select> <span class="error" id="fullname"></span>
			</div>
			<div class="per_form">
		...
		<div class="register_div">
			<div class="per_form">
				<label>Description: </label> <input type="text" id="description"
					name="description" /> <span class="error" id="fullname"></span>
			</div>
			<div class="per_form">
				<label>Amount: </label><input type="number" id="amount"
					name="amount" /> <span class="error" id="fullname"></span>
			</div>
			<div class="per_form">
