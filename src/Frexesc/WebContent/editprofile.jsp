...
function isChanged(nama, tel, add, cit, prov, posta) {
	if (nama == "<%=user.getNama()%>" && tel == "<%=user.getHandphone()%>" && add == "<%=user.getAlamat()%>" && cit == "<%=user.getKota()%>" && prov == "<%=user.getProvinsi()%>" && posta == "<%=user.getKodepos()%>") {
		...
		<div class='register_div'>
			...
			<div class="per_form">
				<label>Nama Lengkap</label><input type="text"
					value="${user.getNama()}" name="name" id="name" required
		...
		<div class='register_div'>
			<div class='per_form small'>
				<label class='uncheck'>Alamat</label><input type="text"
					name="address" id="address" value="${user.getAlamat()}"
			...
			<div class='per_form small'>
				<label>Provinsi</label> <select value="" name="province"
					...
					%>
					<%
						if (provinsi.equals(((UserBean) request.getAttribute("user")).getProvinsi())) {
					%>
			...
			<div class='per_form small'>
				<label class='uncheck'>Kota/Kabupaten</label><input type="text"
					name="city" id="city" value="${user.getKota()}"
			...
			<div class='per_form small'>
				<label class='uncheck'>Kodepos</label><input type="text"
					name="postal" id="postal" value="${user.getKodepos()}"
			...
			<div class='per_form small'>
				<label class='uncheck'>Telepon</label><input type="text"
					name="telephone" id="telephone" value="${user.getHandphone()}"
