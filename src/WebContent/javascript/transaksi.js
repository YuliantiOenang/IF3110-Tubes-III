...
if(localStorage.wbduser){
	...
	function tempBuy(id_brg,qtty){
		...
		xmlhttp.open("POST","webservice?url=http://dichbar.ap01.aws.af.cm/ajaxbeli?type=plain",true);
	...
	function generateSideBar(tab_shopping){
		...
		xmlhttp.open("POST","webservice?url=http://dichbar.ap01.aws.af.cm/fillsidebar",true);
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	...
	function buy(){
		...
		xmlhttp.open("POST","webservice?url=http://dichbar.ap01.aws.af.cm/buyprocess",true);
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
