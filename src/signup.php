<?php
   ...
   $return = $client->__soapCall("Login",array($_POST['nama_lengkap'],$_POST['kobupaten'],$_POST['kodepos'],$_POST['email'],$_POST['handphone'],$_POST['password'],$_POST['username'],$_POST['provinsi'],$_POST['alamat']));
   $mysql2=json_decode($return,true);
   $mysql=$mysql2['status'];
		if($mysql)
		{

			$url= "http://if3110tubes3.herokuapp.com/REST/getNoPelanggan/".$_POST['email']."/".$_POST['password'];
