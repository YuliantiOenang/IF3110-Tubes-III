...
function readysubmit(no,val)
{
	...
	if(isValid==4)document.getElementById("save").disabled = false;
}
...
<article id="featured" class="body">
		...
		<input type="button" onclick="ceksama()" value="Save" id="save" disabled> <a href='profile.php'>Kembali</a></form>
</article><!-- /#featured -->
