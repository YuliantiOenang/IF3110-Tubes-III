...
var Register = {
	...
	cekUsername: function(url){
		...
		if (username.length < 5) {
			...
			xmlhttp.open("GET",url+"/api/checkUsername?username="+username,true);
			xmlhttp.send();
		}
	},
	...
	cekEmail: function(url){
		...
		if (!this.isValidEmail(email)) {
			...
			xmlhttp.open("GET",url+"/api/checkEmail?email="+email,true);
			xmlhttp.send();
		}
	},
	validasi: function(){
