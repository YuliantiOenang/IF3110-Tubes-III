...
<div class='header_divider'>
	...
	<div class="sorting">
		<a href="tambah" class="btn small">Tambah Barang</a>
	</div>
</div>
	...
	<%
		...
		for (HashMap<String, String> value : (Vector<HashMap<String,String>>)request.getAttribute("model")) {
			if ((idxnow>=idx)&&(idxnow<(idx+10)))
			{
				...
				out.print("<a href='edit?id="+value.get("id") + "'><img src='"+request.getContextPath()+"/img/site/edit_icon.png'/></a>");
				out.print("</div>");
