...
<body>
	...
	<div id="container">
		...
		<div id="sort-bar" class="frame">
			...
			<button type="button" onClick="location.href='FrozenFood.php?SortBy=Nama&f=1&l=10'">Nama</button>
			<button type="button" onClick="location.href='FrozenFood.php?SortBy=Harga&f=1&l=10'">Harga</button>
		</div>
