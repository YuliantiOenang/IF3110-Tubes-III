...
public class SoapServiceLocator extends org.apache.axis.client.Service implements tubes2wbd.SoapService {
    ...
    private java.lang.String soap_address = "http://localhost:8080/dichbar/services/soap";
    ...
    public tubes2wbd.Soap getsoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tubes2wbd.SoapSoapBindingStub _stub = new tubes2wbd.SoapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tubes2wbd.Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                tubes2wbd.SoapSoapBindingStub _stub = new tubes2wbd.SoapSoapBindingStub(new java.net.URL(soap_address), this);
                _stub.setPortName(getsoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tubes2wbd", "soapService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tubes2wbd", "soap"));
        }
