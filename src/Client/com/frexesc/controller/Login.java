...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("DEBUG"+userObj.getID()+userObj.getUsername()+userObj.getRole());
			if (userObj.equals(null) == false){
				session.setAttribute("user_id", userObj.getID());
				session.setAttribute("username", userObj.getUsername());
				session.setAttribute("role", String.valueOf(userObj.getRole()));
