...
<article id="featured" class="body">
		...
		<pre>(*) Harus diisi.</pre>
		<pre>Username*			<input type="text" name="username" id="usnm" disabled="disabled"><span id="validasiUser"></span></pre>
		...
		<pre>Email*				<input type="text" name="email" id="email" disabled="disabled"/><span id="validasiEmail"></span></pre>
