...
<div class = "bodymain">
	...
	<div class = "boddy">
		...
		<div class = "topthreecat">
			<?php
				$url= "http://if3110tubes3.herokuapp.com/REST/topThree/Jaket";
		...
		<div class = "topthreecat">
			<?php
				$url= "http://if3110tubes3.herokuapp.com/REST/topThree/Sweater";
				$response=json_decode(file_get_contents($url));
				echo $response;
			?>		</div>
		<div class = "topfivetitle">
		...
		<div class = "topthreecat">
						<?php
				$url= "http://if3110tubes3.herokuapp.com/REST/topThree/TShirt";
				$response=json_decode(file_get_contents($url));
				echo $response;
			?>
		</div>
		...
		<div class = "topthreecat">
						<?php
				$url= "http://if3110tubes3.herokuapp.com/REST/topThree/Misc";
				$response=json_decode(file_get_contents($url));
				echo $response;
			?>
		</div>
		...
		<div class = "topthreecat">
			<?php
				$url= "http://if3110tubes3.herokuapp.com/REST/topThree/Pokemon";
				$response=json_decode(file_get_contents($url));
				echo $response;
			?>
		</div>
