	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
	        ...
	        while(rs.next()){
				...
				out.println("Masukkan jumlah yang akan dibeli: ");
				out.println("<input type='number' name='qty"+ id +"' min='0' id='qty"+id+"'><input type='button' value='Beli!' id='buy' onclick='tempBuy("+id+",qty"+ id +".value)'>");
				out.println("</div></div>");
	        }
