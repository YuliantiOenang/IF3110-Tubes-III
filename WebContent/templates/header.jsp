<div class="header">
	...
	<div class="navigation">
		<a href="category.jsp?idPage=1&pagi=1">
			<div id="navigator">APPETIZER</div>
		</a>
		<a href="category.jsp?idPage=2&pagi=1">
			<div id="navigator">PIZZA</div>
		</a>
		<a href="category.jsp?idPage=3&pagi=1">
			<div id="navigator">PASTA</div>
		</a>
		<a href="category.jsp?idPage=4&pagi=1">
			<div id="navigator">DESSERTS</div>
		</a>
		<a href="category.jsp?idPage=5&pagi=1">
