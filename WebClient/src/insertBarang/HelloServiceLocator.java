...
public class HelloServiceLocator extends org.apache.axis.client.Service implements insertBarang.HelloService {
    ...
    public insertBarang.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            insertBarang.HelloSoapBindingStub _stub = new insertBarang.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (insertBarang.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                insertBarang.HelloSoapBindingStub _stub = new insertBarang.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://insertBarang", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://insertBarang", "Hello"));
        }
